...
CREATE TABLE public.classification (
  ...
  classification_name CHARACTER VARYING(30) NOT NULL,
...
CREATE TABLE public.inventory (
  ...
  inv_make CHARACTER VARYING(30) NOT NULL,
  inv_model CHARACTER VARYING(30) NOT NULL,
  inv_year CHARACTER(4) NOT NULL,
  inv_description TEXT NOT NULL,
  inv_image CHARACTER VARYING(50) NOT NULL,
  inv_thumbnail CHARACTER VARYING(50) NOT NULL,
  inv_price NUMERIC(9, 0) NOT NULL,
  inv_miles INT NOT NULL,
  inv_color CHARACTER VARYING(20) NOT NULL,
...
CREATE TABLE public.account (
  ...
  account_firstname CHARACTER VARYING(30) NOT NULL,
  account_lastname CHARACTER VARYING(30) NOT NULL,
...
VALUES (
  ...
  (
    ...
    'Custom',
    '2007',
    'Ever want to be a super hero? now you can with the batmobile. This car allows you to switch to crash mode allowing for a shorter wheelbase and becomes a tank.',
  ...
  (
    ...
    'Surveillance Van',
    '2016',
    'Do you like police shows? You will feel right at home driving this van. come complete with survalence equipments for an extra fee of $2,000 a month.',
    '/images/survan.jpg',
  ...
  (
    ...
    'Adventador',
    '2016',
    'This V-12 engine packs a punch in this spacious car. Smooth ride with a cool look.',
  ...
  (
    ...
    'Aerocar',
    '1963',
    'Are you sick of rushhour traffc? This car converts into an airplane to get you where you are going fast. Only 6 of these were made, get them while they last!',
    '/images/aerocar.jpg',
  ...
  (
    ...
    'Truck',
    '1995',
    'Most trucks are for working, this one is for fun. this beast comes with 60 inch tires giving you tracktion needed to jump and roll in the mud.',
  ...
  (
    ...
    'Hummer',
    '2016',
    'Do you have 6 kids and like to go offroading? The Hummer gives you the small interiors with an engine that can get you out of any muddy or rocky situation.',
    '/images/hummer.jpg',
